...
import { Svg, Polygon, Path, Rect } from '@react-pdf/renderer';
import { COLORS } from './reportConstants';

/**
 * Zolderpunt logo rendered as inline SVG for @react-pdf/renderer.
 * Source: src/assets/logo-blauw.svg (viewBox 0 0 1080 419.1)
 */
export default function LogoPdf({ width = 120 }: { width?: number }) {
  ...
  return (
    <Svg viewBox="0 0 1080 419.1" style={{ width, height }}>
      ...
      {/* l */}
      <Rect x="675.58" y="0.02" width="29.74" height="185.41" fill={fill} />
      ...
      {/* punt (dot) */}
      <Rect x="928.16" y="335.01" width="28.4" height="28.4" fill={fill} />
    </Svg>
  );
}
